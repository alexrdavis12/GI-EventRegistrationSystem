...
$(document).ready(function(){
	...
	$('#create_q_btn').click(function(evt){
		...
		$("#q_form").append("<div class='panel panel-success' id='Q" + current_qid + "'><div class='panel-heading'><h3 class='panel-title'>Question<a class='btn btn-default' type='hidden' href='#'><i class='fa fa-caret-square-o-up fa-2x'></i></a><a class='btn btn-default' type='hidden' href='#'><i class='fa fa-caret-square-o-down fa-2x'></i></a></h3></div><div class='panel-body'><div class='form-group'><input class='form-control' name='Q" + current_qid + "[title]' value=''></div>" + q_type_str+ "</div></div></div>");
		hookClickSel();
	});
...
//<input id='up_btn' onclick='' style='float:right' type='button' value='/'>