...
function add_subquestion(select_qid, option_id) {
	...
	q_type_str = '<div class="form-group">\
                	  ...
                	  <a class="btn btn-danger" href="javascript:delete_subquestion(' + select_qid + ', ' + option_id + ',' + cnt + ')"><i class="fa fa-trash-o fa-lg"></i> Delete Question</a>\
                	  </div>';
...
function trigger_option_subquestion(dom_obj, select_qid, option_id, subqcnt) {
	dom_obj.parent().after("<div id='Q" + select_qid + "_" + option_id + "_" + subqcnt + "_optdiv' class='form-group'><div class='panel panel-default'>\
				   ...
				   <input id='Q" + select_qid + "_" + option_id + "_" + subqcnt + "_insertpos' class='btn btn-danger pull-right' href='javascript:add_optionsforsub(" + select_qid + "," + option_id + "," + subqcnt + ")'><i class='fa fa-plus fa-lg'></i> Add Option</a>\
				   </div></div></div></div>");
}
