...
$(document).ready(function(){
	...
	$('#create_q_btn').click(function(evt){
		...
		$("#q_form").append("<div class='panel panel-success' id='Q" + current_qid + "'><div class='panel-heading'><h3 class='panel-title'>Question</h3><input id='up_btn' onclick='' style='float:right' type='button' value='/\\'><input id='down_btn' onclick='' style='float:right' type='button' value='\\/'></div><div class='panel-body'><div class='form-group'><input class='form-control' name='Q" + current_qid + "[title]' value=''></div>" + q_type_str+ "</div></div></div>");
		hookClickSel();
	});
